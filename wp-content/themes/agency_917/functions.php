...
function agency_setup() {
	...
	register_nav_menus(
		array(
			'main-menu' => esc_html__( 'Primary menu', 'agency' ),
		)
	);
...
function agency_scripts() {
	wp_enqueue_style( 'agency-style', get_template_directory_uri() . '/dist/css/style.css', array(), _S_VERSION );
	wp_enqueue_script( 'agency-navigation', get_template_directory_uri() . '/dist/js/common.js', array(), _S_VERSION, true );
}
